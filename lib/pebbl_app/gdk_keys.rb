...
module PebblApp
  ...
  module GdkKeys
    ...
    ##
    ## e.g on reference to PebblApp:GdkKeys::Key_Tab Ruby will autoload
    ## the constant's definition from the file ./gdk_keys/key_Tab.rb
    ##
    ## Each constant's value will be defined in each ./gdk_keys/key_*.rb file
    ...
    ## each constant value within PebblApp::GdkKeys.constants.grep(/^Key_/)
    ## should remain consistent.
    ##
    ## If an application may require any alternate methodology for
    ## initialization of key code constants, the set of constants
    ## /^Key_/ defined in this module PebblApp::GdkKeys can be parsed
    ...
    %w(VoidSymbol BackSpace Tab Linefeed Clear Return Pause Scroll_Lock
      ...
      fname = File.join(__dir__, "gdk_keys", "key_" + key + ".rb")
    ...
    class << self
      ...
      ## constant in the module GdkKeys. If a matching constant is found,
      ...
      def key_code(key)
        ...
        when String, Symbol
          ...
          if PebblApp.GdkKeys.const_defined?(name)
            return PebblApp.GdkKeys.const_get?(name)
          else
      ...
      ## Examples
      ## ~~~~
      ## PebblApp::GdkKeys.modifier_mask([:mod1, :control])
      ## => 12
      ##
      ## PebblApp::GdkKeys.modifier_mask("MOD1")
      ## => 8
      ##
      ## PebblApp::GdkKeys.modifier_mask(:control)
      ## => 4
      ##
      ## PebblApp::GdkKeys.modifier_mask(false)
      ## => 0
      ##
      ## PebblApp::GdkKeys.modifier_mask(12)
      ## => 12
      ## ~~~~
      ##
