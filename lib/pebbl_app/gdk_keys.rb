...
module PebblApp
  ...
  module GdkKeys
    ...
    class << self
      ...
      ##
      ## The `key` argument may be provided as a string,
      ## symbol, integer, or either of the literal values nil or false.
      ##
      ...
      ##
      ## The `mask` argument may be provided as a string,
      ## symbol, array, Gdk::ModifierType, integer, or either of the
      ## literal values nil or false.
      ##
      ## If an array, the integer returned will provide a bitwise mask
      ## for the set of modifier keys named in that array.
      ##
      ## If provided as a string or symbol, the string "_MASK" will be
      ## added as a suiffix to the uppcased string representation of the
